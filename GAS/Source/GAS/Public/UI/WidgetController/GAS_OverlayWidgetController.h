...
class GAS_API UGAS_OverlayWidgetController : public UGAS_WidgetController
{
	GENERATED_BODY()
...
template <typename T>
T* UGAS_OverlayWidgetController::GetDataTableRowByTag(UDataTable* DataTable, const FGameplayTag& Tag)
{
